@extends('admin.admin')
@section('navbar_title', 'Danh sách giáo viên')
...
@section('content')
    <div class="panel panel-flat">
        <table class="table table-xlg datatable-ajax" data-source="{{ route('admin_teacher/dataList') }}"
            data-destroymulti="{{route('admin_teacher/destroy-multi')}}">
            <thead>
                <tr>
