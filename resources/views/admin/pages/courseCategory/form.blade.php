...
@section('navbar-right')
    <li>
        <a href="{{ route('admin_courseCategory/index') }}" style="padding:5px 0px 5px 5px">
...
@endsection
@section('content')
    <form method="POST" action="{{ route('admin_courseCategory/save') }}" accept-charset="UTF-8" id="post-form">
        ...
        <div class="col-xs-12 col-sm-12 col-md-3">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        @include('admin.pages.courseCategory.select', ['categories' => $categories])
                    </div>
                </div>
            </div>
            <div class="panel panel-default">
            ...
            <input name="taxonomy" type="hidden" value="course_cat">
