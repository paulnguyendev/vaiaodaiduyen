...
class ComboCourseModel extends Model
{
    use NodeTrait;
    ...
    protected $fillable = ['course_id', 'combo_id', 'created_at', 'updated_at'];
    use HasFactory;
    public function listItems($params = "", $options = "")
    {
        $result = null;
        $query = $this->select('id', 'course_id', 'combo_id', 'created_at', 'updated_at');
    ...
    {
        return $this->belongsTo(ComboModel::class, 'combo_id', 'id');
    }
