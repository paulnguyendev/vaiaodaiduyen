...
class PaymentHistoryModel extends Model
{
    ...
    protected $fillable = ['order_id','user_id','approved_by','note','total_commission','total_point','status','created_at'];
    use HasFactory;
    public function listItems($params = "", $options = "")
    {
        $result = null;
        $query = $this->select('id', 'order_id','user_id','approved_by','note','total_commission','total_point','status','created_at');
