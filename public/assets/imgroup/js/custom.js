...
================================================== */
	...
	//$('#bg_color, #menu_color, #menu_text_color, #menu_text_hover_color, #footer_color, #footer_text_color').ColorPicker({flat: true});
	$('#bg_color').ColorPicker({
		...
		onChange: function (hsb, hex, rgb) {
			$('#bg_color div').css('backgroundColor', '#' + hex);
			$('input[name="bg_color"]').val(hex);
		}
	});
	$('#body_text_color').ColorPicker({
		onShow: function (colpkr) {
			$(colpkr).fadeIn(500);
			return false;
		},
		...
		onChange: function (hsb, hex, rgb) {
			$('#body_text_color div').css('backgroundColor', '#' + hex);
	...
	$('#menu_color').ColorPicker({
		...
		onChange: function (hsb, hex, rgb) {
			$('#menu_color div').css('backgroundColor', '#' + hex);
			$('input[name="menu_color"]').val(hex);
		}
	});
	$('#menu_text_color').ColorPicker({
		onShow: function (colpkr) {
			$(colpkr).fadeIn(500);
			return false;
		},
		...
		onChange: function (hsb, hex, rgb) {
			$('#menu_text_color div').css('backgroundColor', '#' + hex);
			$('input[name="menu_text_color"]').val(hex);
		}
	});
	$('#menu_text_hover_color').ColorPicker({
		onShow: function (colpkr) {
			$(colpkr).fadeIn(500);
			return false;
		},
		...
		onChange: function (hsb, hex, rgb) {
			$('#menu_text_hover_color div').css('backgroundColor', '#' + hex);
			$('input[name="menu_text_hover_color"]').val(hex);
		}
	});
	$('#footer_color').ColorPicker({
		...
		onChange: function (hsb, hex, rgb) {
			$('#footer_color div').css('backgroundColor', '#' + hex);
			$('input[name="footer_color"]').val(hex);
		}
	});
	$('#footer_text_color').ColorPicker({
		...
		onChange: function (hsb, hex, rgb) {
			$('#footer_text_color div').css('backgroundColor', '#' + hex);
			$('input[name="footer_text_color"]').val(hex);
		}
	});
	$('#link_color').ColorPicker({
		...
		onChange: function (hsb, hex, rgb) {
			$('#link_color div').css('backgroundColor', '#' + hex);
			$('input[name="link_color"]').val(hex);
		}
	});
	$('#link_hover_color').ColorPicker({
		...
		onChange: function (hsb, hex, rgb) {
			$('#link_hover_color div').css('backgroundColor', '#' + hex);
			$('input[name="link_hover_color"]').val(hex);
		}
	});
	$('#button_bg').ColorPicker({
		onShow: function (colpkr) {
			$(colpkr).fadeIn(500);
			return false;
		},
		...
		onChange: function (hsb, hex, rgb) {
			$('#button_bg div').css('backgroundColor', '#' + hex);
			$('input[name="button_bg"]').val(hex);
		}
	});
	$('#button_bg_hover').ColorPicker({
		onShow: function (colpkr) {
			$(colpkr).fadeIn(500);
			return false;
		},
		...
		onChange: function (hsb, hex, rgb) {
			$('#button_bg_hover div').css('backgroundColor', '#' + hex);
			$('input[name="button_bg_hover"]').val(hex);
		}
	});
	$('#title_color').ColorPicker({
		...
		onChange: function (hsb, hex, rgb) {
			$('#title_color div').css('backgroundColor', '#' + hex);
			$('input[name="title_color"]').val(hex);
		}
	});
	$('#menu_sub_color').ColorPicker({
		onShow: function (colpkr) {
			$(colpkr).fadeIn(500);
			return false;
		},
		...
		onChange: function (hsb, hex, rgb) {
			$('#menu_sub_color div').css('backgroundColor', '#' + hex);
			$('input[name="menu_sub_color"]').val(hex);
		}
	});
	$('#button_color').ColorPicker({
		...
		onChange: function (hsb, hex, rgb) {
			...
			$('input[name="button_color"]').val(hex);
		}
	});
	$('#button_hover_color').ColorPicker({
		...
		onChange: function (hsb, hex, rgb) {
			$('#button_hover_color div').css('backgroundColor', '#' + hex);
			$('input[name="button_hover_color"]').val(hex);
		}
	});
	$('#price_color').ColorPicker({
		...
		onChange: function (hsb, hex, rgb) {
			$('#price_color div').css('backgroundColor', '#' + hex);
			$('input[name="price_color"]').val(hex);
		}
	});
